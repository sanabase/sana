...
const Map<String, Map<String, String>> _translations = {
  ...
  'zh': {
    ...
    'manual_content':
        '1. 在网页端安全管理您的健康记录，并随时随地通过任何设备访问您的数据。\n2. 轻松添加并跟踪每日药物用量和频率。\n3. 保存医生专科信息与联系方式。\n4. 保存常用药房地址与联系电话。\n5. 设置多时间段带提示的服药提醒。\n6. 拍摄并保存医疗报告与检查单。\n7. 保存医保卡正面和反面照片。\n8. 随时勾选并向医生分享您的健康档案。\n9. 将应用程序安装到您的设备上，以获得全部功能并启用服药提醒和闹钟。\n10. 获取属于您自己的私密专属副本，任何其他人都无法看到。\n11. 要在您的设备上安装 SANA，请在手机浏览器中打开应用：在 Android Chrome 中，打开 ⋮ 菜单并选择“安装应用”或“添加到主屏幕”；在 iPhone Safari 中，点击“分享”并选择“添加到主屏幕”。',
    'taken': '已服药',
    'alarm': '服药提醒',
