...
const Map<String, Map<String, String>> _translations = {
  ...
  'es': {
    ...
    'pwa_install_hint':
        'Instala SANA en tu teléfono para recordatorios fiables.',
    'pwa_step_1': 'Toca el botón Compartir en la parte inferior de Safari.',
    'pwa_step_2': 'Desplázate y toca "Añadir a pantalla de inicio".',
    'pwa_step_3': 'Toca "Añadir" en la parte superior derecha.',
    'taken': 'Tomado',
  ...
  'fr': {
    ...
    'pwa_install_hint':
        'Installez SANA sur votre téléphone pour des rappels fiables.',
    'pwa_step_1': 'Appuyez sur le bouton Partager en bas de Safari.',
    'pwa_step_2': 'Faites défiler et appuyez sur "Sur l’écran d’accueil".',
    'pwa_step_3': 'Appuyez sur "Ajouter" en haut à droite.',
    'taken': 'Pris',
  ...
  'de': {
    ...
    'pwa_install_hint':
        'Installieren Sie SANA auf Ihrem Telefon für zuverlässige Erinnerungen.',
    'pwa_step_1': 'Tippen Sie unten in Safari auf Teilen.',
    'pwa_step_2': 'Scrollen Sie und tippen Sie auf "Zum Home-Bildschirm".',
    'pwa_step_3': 'Tippen Sie oben rechts auf "Hinzufügen".',
    'taken': 'Eingenommen',
  ...
  'tr': {
    ...
    'pwa_install_hint':
        'Güvenilir hatırlatıcılar için SANA’yı telefonunuza yükleyin.',
    'pwa_step_1': 'Safari’nin altındaki Paylaş düğmesine dokunun.',
    'pwa_step_2': 'Kaydırın ve "Ana Ekrana Ekle" seçeneğine dokunun.',
    'pwa_step_3': 'Sağ üstteki "Ekle" düğmesine dokunun.',
    'taken': 'Alındı',
    'alarm': 'İlaç Alarmı',
  ...
  'hi': {
    ...
    'pwa_install_hint':
        'भरोसेमंद रिमाइंडर के लिए SANA को अपने फ़ोन पर इंस्टॉल करें।',
    'pwa_step_1': 'Safari के नीचे शेयर बटन पर टैप करें।',
    'pwa_step_2': 'स्क्रॉल करें और "होम स्क्रीन पर जोड़ें" पर टैप करें।',
    'pwa_step_3': 'ऊपर दाईं ओर "जोड़ें" पर टैप करें।',
    'taken': 'दवा ले ली',
    'alarm': 'दवा का अलार्म',
  ...
  'zh': {
    ...
    'pwa_install_hint': '在手机上安装 SANA，以获得可靠的提醒。',
    'pwa_step_1': '点击 Safari 底部的分享按钮。',
    'pwa_step_2': '向下滚动并点击“添加到主屏幕”。',
    'pwa_step_3': '点击右上角的“添加”。',
    'taken': '已服药',
    'alarm': '服药提醒',
...
class _RecordListScreenState extends State<RecordListScreen> {
  ...
  Future<void> _saveRecord(Map<String, dynamic> result) async {
    ...
    final cleanPayload = <String, dynamic>{
      'user_id': widget.guestMode ? currentUser?.id : widget.ownerId,
